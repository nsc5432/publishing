    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                today: cn(
                    'bg-accent text-accent-foreground rounded-md data-[selected]:rounded-none',
...
function CalendarDayButton({
    ...
    return (
        <Button
            ...
            className={cn(
                'data-[selected-single]:bg-primary data-[selected-single]:text-primary-foreground data-[range-middle]:bg-accent data-[range-middle]:text-accent-foreground data-[range-start]:bg-primary data-[range-start]:text-primary-foreground data-[range-end]:bg-primary data-[range-end]:text-primary-foreground group-data-[focused]/day:border-ring group-data-[focused]/day:ring-ring/50 dark:hover:text-accent-foreground flex aspect-square w-auto h-auto w-full min-w-[var(--cell-size)] flex-col gap-1 leading-none font-normal group-data-[focused]/day:relative group-data-[focused]/day:z-10 group-data-[focused]/day:ring-[3px] data-[range-end]:rounded-md data-[range-end]:rounded-r-md data-[range-middle]:rounded-none data-[range-start]:rounded-md data-[range-start]:rounded-l-md [&>span]:text-xs [&>span]:opacity-70',
                defaultClassNames.day,
                className,
            )}
            {...props}
