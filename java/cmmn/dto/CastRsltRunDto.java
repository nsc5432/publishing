...
@Getter
@Setter
public class CastRsltRunDto extends AomsDefaultDto {
	...
	private String queueLengthCurrent = "";
	...
	public String toString() {
		return "CastRsltRunDto [blockResourceID=" + blockResourceID + ", selfID=" + selfID + ", parentID=" + parentID
				...
				+ waitingTimeMin + ", waitingTimeMax=" + waitingTimeMax + ", waitingTimeAvg=" + waitingTimeAvg + ", queueLengthCurrent=" + queueLengthCurrent
