...
@Getter
@Setter
public class SrvcParaDto extends AomsDefaultDto {
    ...
    private String psgSrvcParaCd            = "";
    private String psgSrvcParaCdNm          = "";
    private String psgSrvcParaExpln         = "";
    private String psgSmltAplcnNm           = "";
    private String psgSmltAplcnExpln        = "";
