...
@Getter
@Setter
public class FixParaDto extends AomsDefaultDto {
    ...
    private String psgFixParaGroupCd		= "";
    private String psgFixParaCd             = "";
    private String psgFixParaCdNm           = "";
    private String psgFixParaExpln          = "";
    private String psgFixParaCndTypeCd      = "";
    private String psgSmltAplcnNm           = "";
    private String psgFixParaCndVl          = "";
    private String vlType                   = "";
    private String useYn                    = "";
    private String prePrcsYn                = "";
    private String psgFixLvl				= "";
    
    private String lvlVl					= "";
}