...
@Getter                                                                            
@Setter                                                                            
public class SmltVrfcDto extends AomsDefaultDto {                                  
    ...
    private BigDecimal fcltySn              = BigDecimal.ZERO;	/** 시설물일련번호 **/
    ...
    private BigDecimal nodeId               = BigDecimal.ZERO;	/** 교점아이디 **/
    private BigDecimal lclsfCd              = BigDecimal.ZERO;	/** 대분류코드 **/
    private BigDecimal mclsfCd              = BigDecimal.ZERO;	/** 중분류코드 **/
    private BigDecimal sclsfCd              = BigDecimal.ZERO;	/** 소분류코드 **/
